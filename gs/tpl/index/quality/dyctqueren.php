        ...
        <div class="Tables">
            <div class="TablesHead">
                <form action="" method="get">
                    ...
                    <span class="Btn Btn-blue float-right NewPop" data-url="<?php echo spUrl($c, 'editDyctlog',array('type'=>2)) ?>" data-title="添加确认检验记录"><i class="icon-add"></i> 新增</span>
                </form>
            </div>
            <?php if ($results) { ?>
                <div class="top20">
                                ...
                                <tr class="Results<?php echo $v['id'] ?>">
                                    ...
                                    <td>
                                        <div class="list-menu" style="display: inline-block;">
                                            操作  ＋
                                            <ul class="menu">
                                                <li class="menu-item NewPop" data-url="<?php echo spUrl($c, 'dyctlogInfo', array('id' => $v['id'],'mid'=>13)) ?>" data-title="确认检验记录详情"><a >详情</a></li>
                                                <li class="menu-item NewPop" data-url="<?php echo spUrl($c, 'editDyctlog', array('id' => $v['id'])) ?>" data-title="编辑确认检验记录"><a >编辑</a></li>
