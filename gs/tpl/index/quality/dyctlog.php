        ...
        <div class="Tables">
            <div class="TablesHead">
                <form action="" method="get">
                    ...
                    <span class="Btn Btn-blue float-right NewPop" data-url="<?php echo spUrl($c, 'editDyctlog',array('type'=>1)) ?>" data-title="添加例行检验记录"><i class="icon-add"></i> 新增</span>
                </form>
            </div>
            <?php if ($results) { ?>
                <div class="top20">
                                    ...
                                    <td>
                                        <div class="list-menu" style="display: inline-block;">
                                            ...
                                            <ul class="menu">
                                                ...
                                                <li class="menu-item NewPop" data-url="<?php echo spUrl($c, 'editDyctlog', array('id' => $v['id'], 'type' => $v['dytype'], 'mid' => $v['mid'])) ?>" data-title="编辑例行检验记录"><a >编辑</a></li>
