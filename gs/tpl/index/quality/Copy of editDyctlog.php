                        ...
                        <table class="Table TabInp textCenter">
                                ...
                                <tr>
                                    ...
                                    <th colspan="2" class="textLeft">
                                        <select name="mid" class="FrameGroupInput">
                                            <option value="-1">产品参数</option>
                                            <?php foreach($paras as $k=>$v){?>
                                            <option <?php echo $type==$k?'selected=""':''?> value="<?php echo $k?>"><?php echo $v['name']?></option>
                                            <?php }?>
                                        </select>
                                    </th>
                                </tr>
                            ...
                            <tbody class="TabInp">
                                ...
                                <tr>
                                    ...
                                    <td><textarea name="" id="" class="FrameGroupInput"></textarea></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td colspan="2">5.电气间隙≥10mm</td>
                                    <td><textarea name="" id="" class="FrameGroupInput"></textarea></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td colspan="2">6.爬电距离≥14mm</td>
                                    <td><textarea name="" id="" class="FrameGroupInput"></textarea></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td>绝 缘 电 阻的验证</td>
                                    <td colspan="2">相对地标称电压的绝缘电阻应>1000Ω/V</td>
                                    <td><textarea name="" id="" class="FrameGroupInput"></textarea></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="2">施加交流正弦波50Hz电压2500V施压时间1s,施压部位如下:结论:不可有击穿或闪络现象。</td>
                                    <td><textarea name="" id="" class="FrameGroupInput"></textarea></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="2">3.绝缘材料制造的外壳和手柄上覆盖金属箔,在金属箔上与带电部件以及裸导电部件之间施电压,但其值为<input class="FrameGroupInput" type="text" name="" placeholder="3750V"></td>
                                    <td><textarea name="" id="" class="FrameGroupInput"></textarea></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="2">仪表门对主接地≤<input class="FrameGroupInput" type="text" name="" value="" placeholder="100Ω/V"></td>
                                    <td><textarea name="" id="" class="FrameGroupInput"></textarea></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td colspan="2">主断路器框架对主接地≤<input class="FrameGroupInput" type="text" name="" value="" placeholder="100Ω/V"></td>
                                    <td><textarea name="" id="" class="FrameGroupInput"></textarea></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td colspan="2">分支断路器/熔断器框架对主接地≤<input class="FrameGroupInput" type="text" name="" value="" placeholder="100Ω/V"></td>
                                    <td><textarea name="" id="" class="FrameGroupInput"></textarea></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td colspan="2">端子排支架对主接地≤<input class="FrameGroupInput" type="text" name="" value="" placeholder="100Ω/V"></td>
                                    <td><textarea name="" id="" class="FrameGroupInput"></textarea></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td colspan="2">互感器对主接地≤<input class="FrameGroupInput" type="text" name="" value="" placeholder="100Ω/V"></td>
                                    <td><textarea name="" id="" class="FrameGroupInput"></textarea></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="2">检查装置接线正确无误后，在辅助电路分别通以额定电压的85%、110％，各操作 5 次，应符合要求</td>
                                    <td><textarea name="" id="" class="FrameGroupInput"></textarea></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td colspan="2">对主开关操作手柄，操作 5 次，机构应动作可靠，正常。</td>
                                    <td><textarea name="" id="" class="FrameGroupInput"></textarea></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td>防护等级</td>
                                    <td colspan="2">进行直观检查以保证规定的防护等级<input type="text" class="FrameGroupInput" name="" type="text" placeholder="IP30"></td>
                                    <td><textarea name="" id="" class="FrameGroupInput"></textarea></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="6">
                                        结论:该产品经检验合格符合 GB/T15576-2008 检验要求
                                    </td>
                                </tr>
                                <!--GGJ低压无偿柜参数end-->
                                <!--JP电容柜参数start-->
                                ...
                                <tr>
                                    <td>防护等级</td>
                                    <td>防护等级应达到<input type="text" placeholder="IP44" class="FrameGroupInput" name="">，工厂生产工艺和产品结构应符合相关要求。</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>5.电气间隙≥<input type="text" class="FrameGroupInput" placeholder="10mm"></td>
                                </tr>
                                <tr>
                                    <td>6.爬电距离≥<input type="text" class="FrameGroupInput" placeholder="14mm"></td>
                                </tr>
                                <tr>
                                    <td>绝缘电阻的验证</td>
                                    <td>相对地标称电压的绝缘电阻应><input type="text" placeholder="1000Ω/V" name="" class="FrameGroupInput"></td>
                                </tr>
                                <tr>
                                    <td>外接导线端子</td>
                                ...
                                <tr>
                                    ...
                                    <td>施加交流正弦波 50Hz 电压<input type="text" class="FrameGroupInput" name="" placeholder="2500V">施压时间 <input type="text" class="FrameGroupInput" name="" placeholder="1s">,施压部位如下: 结论:不可有击穿或闪络现象。</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>3.绝缘材料制造的外壳和手柄上覆盖金属箔,在金属箔上与带电部件以及裸导电部件之间施电压,但其值为 <input type="text" class="FrameGroupInput" name="" placeholder="3750V">。</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>仪表门对主接地≤<input type="text" class="FrameGroupInput" name="" placeholder="100mΩ"></td>
                                </tr>
                                <tr>
                                    <td>主断路器框架对主接地≤<input type="text" class="FrameGroupInput" name="" placeholder="100mΩ"></td>
                                </tr>
                                <tr>
                                    <td>分支断路器/熔断器安装支架对主接地≤<input type="text" class="FrameGroupInput" name="" placeholder="100mΩ"></td>
                                </tr>
                                <tr>
                                    <td>端子排支架对主接地≤<input type="text" class="FrameGroupInput" name="" placeholder="100mΩ"></td>
                                </tr>
                                <tr>
                                    <td>互感器安装支架对主接地≤<input type="text" class="FrameGroupInput" name="" placeholder="100mΩ"></td>
                                </tr>
                                <tr>
                                    <td rowspan="2">通电操作及机械操作试验</td>
                                    <td>检查装置接线正确无误后，在辅助电路分别通以额定电压的 85%、110％，各操作<input type="text" class="FrameGroupInput" name="" placeholder="5">次，应符合要求</td>
                                </tr>
                                <tr>
                                    <td >对主开关操作手柄，操作<input type="text" class="FrameGroupInput" name="" placeholder="5">次，机构应动作可靠，正常。</td>
                                </tr>
                                <tr>
                                    <td>工频过电压保护试验</td>
                                ...
                                <tr>
                                    <td>防护等级</td>
                                    <td>物体试具</td>
                                    <td>达到防护等级 <input type="text" class="FrameGroupInput" name="" placeholder="IP30">。用直径 <input type="text" class="FrameGroupInput" name="" placeholder="2.5+0.05 mm">直的硬钢丝，钢丝应不能进入壳内。</td>
                                </tr>
                                <tr>
                                    <td>开关器件和元件的组合</td>
                                ...
                                <tr>
                                    ...
                                    <td>电气间隙：检验部位：相与相之间≥<input type="text" class="FrameGroupInput" name="" placeholder="5.5mm"></td>
                                </tr>
                                <tr>
                                    <td>爬电距离</td>
                                    <td>爬电距离：检验部位：相与相之间≥<input type="text" class="FrameGroupInput" name="" placeholder="5.5mm"></td>
                                </tr>
                                <tr>
                                    <td>绝缘电阻的验证</td>
                                    <td>绝缘电阻表</td>
                                    <td>相对地标称电压的绝缘电阻应><input type="text" class="FrameGroupInput" name="" placeholder="1000Ω/V"></td>
                                </tr>
                                <tr>
                                    <td>电击防护和保护电路完整性</td>
                                    <td>接地电阻测试仪</td>
                                    <td>允许值应≤<input type="text" class="FrameGroupInput" name="" placeholder="100mΩ">，测试电流≥<input type="text" class="FrameGroupInput" name="" placeholder="10A">，测量在进线保护导体的端子成套设备相应的裸露导电部件之间电阻值均应≤<input type="text" class="FrameGroupInput" name="" placeholder="100mΩ"></td>
                                </tr>
                                <tr>
                                    <td>介电性能</td>
                                    <td>耐压测试仪</td>
                                    <td>试压时间<input type="text" class="FrameGroupInput" name="" placeholder=" 1S">，施压部位及值如下:主电路相间、相对地及与主回路直接相连接的辅助回路与地之间（<input type="text" class="FrameGroupInput" name="" placeholder="1890V">）；非主电路供电的辅助回路与地之间（1890V）；（适用时）带电部分和用金属箔包裹的整个绝缘手柄之间（<input type="text" class="FrameGroupInput" name="" placeholder="2835V">）</td>
                                </tr>
                                <tr>
                                    <td>机械操作</td>
                                    <td>手动</td>
                                    <td>可移式部件的机械操作，包括所有的插入式联销，在成套设备安装好后，验证机械操作是否良好，操作循环次数应为<input type="text" class="FrameGroupInput" name="" placeholder=" 5 ">次是否良好</td>
                                </tr>
                                <tr>
                                    <td colspan="3">检验依据及结论:依据 GB/T7251.3-2017 
                                        <label><span class="radio ">合格</span><input type="radio" name="" class="None" value="1"></label>
                                        ，准予加施 C 3C  标志出厂； 
                                        <label><span class="radio ">不合格</span><input type="radio" name="" class="None" value="0"></label>，返工至合格
                                    </td>
                                </tr>
                                <!--XL-21参数end-->
                                <!--XM电气装配工序流程卡参数start-->
                                ...
                                <tr>
                                    ...
                                    <td>电气间隙符合标准要求≥<input type="text" class="FrameGroupInput" name="" placeholder="5.5mm"></td>
                                </tr>
                                <tr>
                                    <td>爬电距离符合标准要求≥<input type="text" class="FrameGroupInput" name="" placeholder="6.3mm"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>防护等级</td>
                                    <td>物体试具、目测</td>
                                    <td>防护等级应达到<input type="text" class="FrameGroupInput" name="" placeholder="IP20C"></td>
                                </tr>
                                <tr>
                                    <td>开关器件和元件的组合</td>
                                    <td rowspan="2">目测、卷尺</td>
                                ...
                                <tr>
                                    <td>爬电距离</td>
                                    <td>爬电距离：检验部位:相与相之间≥<input type="text" class="FrameGroupInput" name="" placeholder="6.3mm"></td>
                                </tr>
                                <tr>
                                    <td>绝缘电阻的验证</td>
                                    <td>绝缘电阻表</td>
                                ...
                                <tr>
                                    <td>电击防护和保护电路完整性</td>
                                    <td>接地电阻测试仪</td>
                                    <td>允许值应≤<input type="text" class="FrameGroupInput" name="" placeholder="100">，测试电流≥<input type="text" class="FrameGroupInput" name="" placeholder="10A">，测量在进线保护导体的端子成套设备相应的裸露导电部件之间电阻值均应≤<input type="text" class="FrameGroupInput" name="" placeholder="100mΩ"></td>
                                </tr>
                                <tr>
                                    <td>介电性能</td>
                                    <td>耐压测试仪</td>
                                    <td>试压时间<input type="text" class="FrameGroupInput" name="" placeholder="1S">，施压部位及值如下:主电路相间、相对地及与主回路直接相连接的辅助回路与地之间（<input type="text" class="FrameGroupInput" name="" placeholder="1890V">）；非主电路供电的辅助回路与地之间（<input type="text" class="FrameGroupInput" name="" placeholder="1890V">）；（适用时）带电部分和用金属箔包裹的整个绝缘手柄之间（<input type="text" class="FrameGroupInput" name="" placeholder="2835V">）</td>
                                </tr>
                                <tr>
                                    <td>机械操作</td>
                                    <td>手动</td>
