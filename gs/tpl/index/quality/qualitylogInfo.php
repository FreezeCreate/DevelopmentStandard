                        ...
                        <table class="Table TabInp textCenter">
                            <thead>
                                <tr>
                                    ...
                                    <th colspan="9"><input class="textLeft" <?php echo $result['status'] == 0 ? '' : 'readonly="true"' ?> name="number" type="text"value="<?php echo $result['number'] ?>"/></th>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th>验证检查</th><th>外观检查</th><th>尺寸检查</th><th>性能检查</th>
                                </tr>
                            </thead>
