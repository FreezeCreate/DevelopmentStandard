                    ...
                    <div class="top20" id="print">
                        <table class="Table TabInp textCenter">
                            <thead>
                                ...
                                <tr>
                                    <th colspan="12" class="textLeft"><?php echo $shebei['number']?></th>
                                </tr>
                            </thead>
                            <tbody class="TabBg add">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $v['content']['q1']?></td>
                                    <td><?php echo $v['content']['q2']?></td>
                                    <td><?php echo $v['content']['q3']?></td>
                                    <td><?php echo $v['content']['q4']?></td>
                                    <td><?php echo $v['content']['q5']?></td>
                                    <td><?php echo $v['content']['q6']?></td>
                                    <td><?php echo $v['jieguo']?></td>
                                    <td><div class="UpgrapImg">
                                            <?php echo empty($v['sign']) ?'' : '<img class="" src="'.$v['sign'].'"/>'; ?>
                                        </div></td>
                                    <td><?php echo $v['dt']?></td>
