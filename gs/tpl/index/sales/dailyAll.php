                    ...
                    <div class="TablesSerch">
                        <form action="<?php echo spUrl($c, $a, array('type' => $page_con['type'])) ?>" method="get">
                            <label class="form-group">
                                ...
                                ~
                                <input type="text" class="FrameDatGroup notenter" name="end" placeholder="结束时间" id="end" value="<?php echo $page_con['end'] ?>"/>
                            </label>
                            <label class="form-group">
                                部门：<select class="form-control TablesSerchInput" name="dep">
...
<?php } ?>
                            ...
                            <label class="form-group">
                                销售：<select class="form-control TablesSerchInput" name="uid">
                                    <option value='0'>全部</option>
