...
<html>
    ...
    <body>
        ...
        <div class="ContentBox">
         ...
         <a class="btn btn-primary" onclick="fill_apply(7)"><div class="TablesAddBtn">＋添 加</div> </a>
			</div>
                ...
                <tbody>
                    ...
                    <tr class="Results<?php echo $v['id']?>">
                            ...
                            <td class="colorGre">
                                      ...
                                      <ul class="menu">
                                         <li class="menu-item">
                                        <a onclick="check_apply(7, <?php echo $v['id'] ?>)">详情</a></li>
                                        <?php if ($admin['id'] == $v['uid']) { ?>
                                            <li class="menu-item"><a onclick="fill_apply(7, <?php echo $v['id'] ?>)">编辑</a></li>
                                            <?php if ($v['status'] != 0) { ?>
