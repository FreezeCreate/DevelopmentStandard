        ...
        <div class="ContentBox">
            <div class="Tables">
                ...
                <form action="<?php echo spUrl($c, $a) ?>" method="get">
                    ...
                    <label class="form-group">
                        客户：<select class="FrameGroupInput" name="comer">
                            ...
                            <?php foreach ($customer as $k => $v) { ?>
                                <option value="<?php echo $v['id']; ?>" <?php if ($page_con['comer'] == $v['id']) {
                                echo 'selected';
                    ...
                    <label class="form-group">
                        合同编号：<input class="FrameGroupInput" placeholder="合同编号" type="text" name="number" value="<?php echo $page_con['number'] ?>"/>
                    </label>
                    </label>
                    ...
                    <?php foreach ($results as $k => $v) { ?>
                        <tr class="User<?php echo $v['id'] ?>">
                            ...
                            <td class="colorGre">
                                      ...
                                      <ul class="menu">
                                         <li class="menu-item">
                                              <a onclick="check_apply(32,<?php echo $v['id'] ?>)">详情</a>
                                        </li>
<!--                                         <li class="menu-item">
                                              <a onclick="fill_apply(32,<?php echo $v['id'] ?>)">编辑</a>
                                         </li> -->
                                         <li class="menu-item">
                                              <a class="color-red" onclick="del_form(<?php echo $v['id'] ?>)">删除</a>
                                      </li>
                              </ul>
                              </div>
                            </td>
