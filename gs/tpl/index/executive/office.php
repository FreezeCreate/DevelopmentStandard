...
<html>
    ...
    <body>
        ...
        <div class="ContentBox">
			...
			<a class="btn btn-primary" onclick="fill_apply(6)"><div class="TablesAddBtn">＋添 加</div> </a>
			</div>
                    ...
                    <?php foreach ($results as $k => $v) { ?>
                        <tr class="Results<?php echo $v['id'] ?>">
                            ...
                            <td class="colorGre">
                                      ...
                                      <ul class="menu">
                                         <li class="menu-item">
											<a onclick="check_apply(6, <?php echo $v['id'] ?>)">详情</a></li>
                                            <li class="menu-item"><a onclick="fill_apply(6, <?php echo $v['id'] ?>)">编辑</a></li>
