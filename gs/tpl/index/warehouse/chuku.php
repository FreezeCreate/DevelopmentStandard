        ...
        <div class="Tables">
            <div class="TablesHead">
                <form action="" method="get">
                    ...
                    <span class="Btn Btn-blue float-right NewPop" data-url="<?php echo spUrl($c, 'addChuku') ?>" data-title="新增成品出库单"><i class="icon-add"></i> 添加</span>
                </form>
            </div>
            <?php if ($results) { ?>
                <div class="top20">
                                ...
                                <tr class="Results<?php echo $v['id'] ?>">
                                    ...
                                    <td>
                                        <div class="list-menu" style="display: inline-block;">
                                            操作  ＋
                                            <ul class="menu">
                                                <li class="menu-item NewPop" data-url="<?php echo spUrl($c, 'chukuInfo', array('id' => $v['id'])) ?>" data-title="成品出库单详情"><a >详情</a></li>
                                                <li class="menu-item NewPop" data-url="<?php echo spUrl($c, 'addChuku', array('id' => $v['id'])) ?>" data-title="编辑成品出库单"><a >编辑</a></li>
