                ...
                <form id="check_form">
                    ...
                    <div class="top20">
                        <table class="Table TabBg TabInp">
                            <thead>
                                <tr><th colspan="6" style="border:0;"><input type="text" name="pname" value="<?php echo empty($result['name'])?'材料出库单':$result['name']?>" /></th></tr>
                                <tr>
                                    ...
                                    <th style="border:0;"></th>
                                    <th class="textRight" style="border:0;">出库日期：</th>
                                ...
                                <tr><th>工程/项目</th><th>名称</th><th>型号规格</th><th>数量</th><th>制造商/生产厂</th><th>备注</th></tr>
                            </thead>
                            <tbody class="textCenter add">
                                <?php foreach($result['children'] as $v){?>
                                <tr>
                                    <td><input type="text" name="project[]" value="<?php echo $v['project']?>" /></td>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $(function() {
            $('.TabAdd').click(function() {
                $('.add').append(
                        '<tr><td><input type="text" name="project[]" value="" /></td><td><input type="text" name="name[]" value="" /></td><td><input name="format[]" type="text" value="" /></td>'
    ...
    function do_sub() {
        ...
        $.ajax({
            cache: false,
            type: "POST",
            url: "<?php echo spUrl($c, 'saveClchuku'); ?>",
