                                ...
                                <tr class="Results<?php echo $v['id'] ?>">
                                    ...
                                    <td> 
                                        <div class="list-menu" style="display: inline-block;">
                                            操作  ＋
                                            <ul class="menu">
                                                <li class="menu-item NewPop" data-url="<?php echo spUrl($c, 'biangengInfo', array('id' => $v['id'])) ?>" data-title="元器件变更详情"><a >详情</a></li>
                                                <li class="menu-item NewPop" data-url="<?php echo spUrl($c, 'editBiangeng', array('id' => $v['id'])) ?>" data-title="编辑元器件变更申请"><a >编辑</a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
