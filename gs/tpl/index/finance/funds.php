                                ...
                                <?php foreach ($results as $k => $v) { ?>
                                    <tr class="Results<?php echo $v['id'] ?>">
                                        ...
                                        <td>
                                            ...
                                            操作  ＋
                                            <ul class="menu">
                                                <li class="menu-item"><a onclick="check_apply(17, <?php echo $v['id'] ?>)">详情</a></li>
                                                <?php if ($admin['id'] == $v['uid']) { ?>
                                                <li class="menu-item"><a onclick="fill_apply(17, <?php echo $v['id'] ?>)">编辑</a></li>
...
function voidBox(id) {
        ...
        function del(id) {
            Confirm('确定删除？',function(){
                $.get("<?php echo spUrl($c, "delFunds"); ?>", {id: id}, function(data) {
                    if (data.status == 1) {
                        $('.Results' + id).remove();
                    }
                }, 'json');
