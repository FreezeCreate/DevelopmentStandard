            ...
            <form action="" method="" id="check_form" onsubmit="return false;">
                ...
                <div class="FrameCont">
                    <div class="FrameTable">
                        <div class="FrameTableTitl"><input class="textCenter" type="text" name="title" value="文件清单" /></div>
                        <table class="Table TabBg TabInp">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class=""><input type="text" class="dt" name="sxdt[]" value="" /></td>
                                    <td class=""><input type="text" class="dt" name="hsdt[]" value="" /></td>
