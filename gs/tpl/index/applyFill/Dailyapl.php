                    ...
                    <table class="FrameTableCont">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input class="FrameDatGroup" readonly="readonly" type="text" id="date" name="date" value="<?php echo empty($result['date'])?date('Y-m-d'):$result['date'] ?>"/></td>
                                <td class="FrameGroupName" style="width: 150px;">截止时间</td>
                                <td><input class="FrameDatGroup" readonly ="readonly" type="text" id="enddt" name="enddt" value="<?php echo $result['enddt'] ?>"/></td>
                            </tr>
                            <tr class="show1">
...
<!--                            <tr class="show1">
                            ...
                            <tr>
                                <td class="plant FrameGroupName">明日计划</td>
...
//            }
    ...
    function do_sub() {
        ...
        $.ajax({
            cache: false,
            type: "POST",
            url: "<?php echo spUrl($c, "saveDaily2"); ?>",
