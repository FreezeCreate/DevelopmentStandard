    ...
    <div class="Frame">
        ...
        <div class="FrameBox">
            <div class="FrameCont">
                ...
                <form id="do_form">
                    <input type="hidden" name="oid" value="<?php echo empty($result['oid'])?$oid:$result['oid'] ?>"/>
                                ...
                                <tr>
                                    <td colspan="4"class="pdX20">
                                        ...
                                        <div class="UpgrapImg2 textRight" onclick="$('#fileToUploadQm').click();" style="display: inline-block;float: right;">责任人：
                                            <img class="" src="<?php echo empty($admin['zeren']) ? SOURCE_PATH . '/images/qianming.png' : $admin['zeren']; ?>"/>
                                            <input type="hidden" name="zeren" value="<?php echo empty($result['zeren']) ? '':$result['zeren']; ?>"/>
                                        </div>
