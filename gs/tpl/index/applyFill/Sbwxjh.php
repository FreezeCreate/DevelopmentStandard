                        ...
                        <table class="Table TabBg TabInp">
                            ...
                            <tbody class="TabBg textCenter TabInp add">
                                <tr>
                                    ...
                                    <td><input type="text" name="changsuo[]" value=""/></td>
                                    <td><input type="text" class="dt" name="lastdt[]" value=""/></td>
                                    <td><input type="text" class="dt" name="jhdt[]" value=""/></td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    <td><input type="text" name="number[]" value=""/></td>
...
<script>
    $('.TabAdd').click(function(e) {
        ...
        $('.add').append(
                '<tr><td>' + index + '</td><td><input type="text" name="number[]" value=""/></td>'
                                 +'   <td><input type="text" name="name[]" value=""/></td>'
                                 +'   <td><input type="text" name="format[]" value=""/></td>'
                                  +'  <td><input type="text" name="level[]" value=""/></td>'
                                   +' <td><input type="text" name="company[]" value=""/></td>'
                                   +' <td><input type="text" name="changsuo[]" value=""/></td>'
                                    +'<td><input type="text" class="dt" name="lastdt[]" value=""/></td>'
                                    +'<td><input type="text" class="dt" name="jhdt[]" value=""/></td></tr>'
                )
    ...
    function do_sub() {
        ...
        $.ajax({
            cache: false,
            type: "POST",
            url: "<?php echo spUrl($c, "saveSbwxjh"); ?>",
