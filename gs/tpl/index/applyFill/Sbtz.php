            ...
            <form action="" method="" id="check_form" onsubmit="return false;">
                ...
                <div class="FrameCont">
                    <div class="FrameTable">
                        <div class="FrameTableTitl"><input class="textCenter" type="text" name="title" value="检验和试验设备台账" /></div>
                        <table class="Table TabBg TabInp">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class=""><input type="text" name="model[]" value="" /></td>
                                    <td class=""><input type="text" name="shang[]" value="" /></td>
                                    <td class=""><input type="text" name="num[]" value="" /></td>
                                    <td class=""><input type="text" name="address[]" value="" /></td>
                                    <td class=""><input type="text" name="note[]" value="" /></td>
                                </tr>
                                <tr>
                                    <td class="">2</td>
                                    <td class=""><input type="text" name="name[]" value="" /></td>
