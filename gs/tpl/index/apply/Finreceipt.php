...
<html>
    ...
    <body>
        <div class="Frame">
            <div class="FrameTit"><span class="FrameTitName">收款记录详情</span><span class="Close"></span></div>
            <div class="FrameBox">
                <div class="FrameCont">
                    <div class="FrameTable">
                        <div class="FrameTableTitl">收款记录详情</div>
                        <table class="FrameTableCont">
                            <tr>
                                <td class="FrameGroupName"> 收款人：</td>
                                <td><?php echo $result['optname']?></td>
                                <td class="FrameGroupName">日期：</td>
                                <td><?php echo $result['date']?></td>
                            </tr>
                            <tr>
                                <td class="FrameGroupName"> 收款方式：</td>
                                <td><?php echo $GLOBALS['PAY_TYPE'][$result['type']]?></td>
                                <td class="FrameGroupName">收款金额：</td>
                                <td>￥<?php echo $result['money']?></td>
                            </tr>
                            <tr>
                                <td class="FrameGroupName"> 付款方：</td>
                                <td><?php echo $result['payer']?></td>
                                <td></td>
                                <td></td>
                            </tr>
                            <tr>
