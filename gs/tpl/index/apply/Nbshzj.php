                        ...
                        <table class="Table TabBg TabInp">
                            <tbody class="">
                                ...
                                <tr>
                                    ...
                                    <td colspan="4" class="pdX10 pdY20"><?php echo $result['zongshu'] ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="textCenter TabBgBlue pdY20">审核结论</td>
                                    <td colspan="4" class="pdX10 pdY20"><?php echo $result['jielun'] ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="textCenter TabBgBlue pdY20">审核报告分发</td>
                                    <td colspan="4" class="pdX10 pdY20"><?php echo $result['baogao'] ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="textCenter TabBgBlue pdY20">附件情况</td>
                                    <td colspan="4" class="pdX10 pdY20"><?php echo $result['fujian'] ?>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
