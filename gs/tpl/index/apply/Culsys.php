            ...
            <div class="FrameBox">
                <div class="FrameCont">
                    <div class="FrameTable">
                        <div class="FrameTableTitl">文化制度详情</div>
					<table class="FrameTableCont">	
                    <tbody>
                        <tr>
                            <td class="FrameGroupName" width="20%">主题：</td>
                            <td colspan="3"><?php echo $result['name'] ?></td>
                        </tr>
                        <tr>
                            <td class="FrameGroupName">类型：</td>
                            <td><?php echo $GLOBALS['CULSYS_TYPE'][$result['type']]; ?></td>
                            <td class='FrameGroupName'>制定时间：</td>
                            <td><?php echo $result['zddt'];?></td>
                        </tr>
                        <tr>
                            <td class="FrameGroupName">内容：</td>
                            <td colspan="3"><?php echo htmlspecialchars_decode($result['content']); ?></td>
                        </tr>
                    </tbody>
                </table>
