...
<body>
    <div class="Frame">
        <div class="FrameTit"><span class="FrameTitName">文件清单</span><span class="Close"></span></div>
        <div class="FrameBox">
                        ...
                        <table class="Table TabBg TabInp">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class=""><?php echo $v['banben']?></td>
                                    <td class=""><?php echo $v['name']?></td>
                                    <td class=""><?php echo $v['sxdt']?></td>
                                    <td class=""><?php echo $v['hsdt']?></td>
