                        ...
                        <table class="Table TabInp totalItem">
                            <thead>
                                ...
                                <tr class="colorGre">
                                    ...
                                    <th>报价员</th><th class="textLeft pdX10" colspan="2"><input type="text" name="uname" value="<?php echo $result['uname'] ?>"/></th>
                                </tr>
                                <tr class="colorGre">
                                    <th colspan="2">电话</th><th class="textLeft pdX10" colspan="2"><input type="text" name="tel" value="<?php echo $result['tel'] ?>"/></th>
                                    <th>编号</th><th class="textLeft pdX10" colspan="2"><input type="text" name="unumber" value="<?php echo $result['unumber'] ?>"/></th>
                                </tr>
                                <tr class="colorGre">
                                    <th colspan="2">传真</th><th class="textLeft pdX10" colspan="2"><input type="text" name="fax" value="<?php echo $result['fax'] ?>"/></th>
                                    <th>日期</th><th class="textLeft pdX10" colspan="2"><input type="text" name="date" value="<?php echo $result['date'] ?>"/></th>
                                </tr>
                                <tr class="colorGre">
