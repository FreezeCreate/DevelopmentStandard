...
<script src="<?php echo SOURCE_PATH; ?>/js/table.js" type="text/javascript" charset="utf-8"></script>
    <link rel="stylesheet" href="../../../html/css/public.css">
                        ...
                        <tbody class="textCenter TabBg">
                            <?php foreach ($results as $k => $v) { ?>
                                <tr class="Results<?php echo $v['id'] ?>" <?php if (!empty($re_data[$k])){echo 'style="color: red;"';echo 'title='.$re_data[$k]['title'].':'.$re_data[$k]['redesc'].'';}?>>
                                    <td <?php if (!empty($re_data[$k])){echo 'class=l_clock ';echo 'data-content='.$re_data[$k]['title'].':'.$re_data[$k]['redesc'].'';}?>><?php echo $v['number'];?></td>
                                    ...
                                    <td>
                                        <div class="list-menu" style="display: inline-block;">
                                            ...
                                            <ul class="menu">
                                                ...
                                                <?php if ($v['id'] != 1){?><li class="menu-item read"><a onclick="del(<?php echo $v['id'] ?>)">删除</a></li><?php }?>
