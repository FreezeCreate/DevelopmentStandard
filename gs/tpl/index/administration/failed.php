        ...
        <div class="Tables">
            <div class="TablesHead">
                <form action="" method="get">
                    ...
                    <span class="Btn Btn-blue float-right NewPop" data-url="<?php echo spUrl($c, 'addFailed') ?>" data-title="新增不合格报告"><i class="icon-add"></i> 新增</span>
                </form>
            </div>
            <?php if ($results) { ?>
                <div class="top20">
                        ...
                        <tbody class="textCenter TabBg">
                            <?php foreach ($results as $k => $v) { ?>
                                <tr class="Results<?php echo $v['id'] ?>">
                                    ...
                                    <td><?php echo $v['dt'] ?></td>
                                    <td><?php echo $v['tiaokuan'] ?></td>
                                    <td><?php echo $v['chengdu'] ?></td>
                                    <td class="color-<?php echo $status[$v['status']]['color'] ?>"><?php echo $status[$v['status']]['text'] ?></td>
                                    <td>
                                        <div class="list-menu" style="display: inline-block;">
                                            操作  ＋
                                            <ul class="menu">
                                                <li class="menu-item NewPop" data-url="<?php echo spUrl($c, 'failedInfo', array('id' => $v['id'])) ?>" data-title="不合格报告详情"><a >详情</a></li>
