        ...
        <div class="Tables">
            <div class="TablesHead">
                <form action="" method="get">
                    ...
                    <span class="Btn Btn-blue float-right" onclick="fill_apply(21)"><i class="icon-add"></i> 新增</span>
                </form>
            </div>
            <?php if ($results) { ?>
                <div class="top20">
                                ...
                                <tr class="Results<?php echo $v['id'] ?>">
                                    ...
                                    <td>
                                        <div class="list-menu" style="display: inline-block;">
                                            操作  ＋
                                            <ul class="menu">
                                                <li class="menu-item"  onclick="check_apply(21,<?php echo $v['id']?>)"><a >详情</a></li>
