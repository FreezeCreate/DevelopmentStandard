        ...
        <div class="Tables">
            <div class="TablesHead">
                <form action="" method="get">
                    ...
                    <span class="Btn Btn-blue float-right" onclick="fill_apply(20)"><i class="icon-add"></i> 新增</span>
                </form>
            </div>
            <?php if ($results) { ?>
                <div class="top20">
                                ...
                                <tr class="Results<?php echo $v['id'] ?>">
                                    ...
                                    <td> 
                                        <div class="list-menu" style="display: inline-block;">
                                            操作  ＋
                                            <ul class="menu">
                                                <li class="menu-item NewPop" data-url="<?php echo spUrl('apply', 'Nsjc', array('id' => $v['id'])) ?>" data-title="内审检查表详情"><a >详情</a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
