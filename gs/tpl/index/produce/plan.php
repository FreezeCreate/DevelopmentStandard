            ...
            <div class="TablesHead">
                <form action="" method="get">
                    <ul class="TablesHeadNav">
                        ...
                        <li class="TablesHeadItem <?php echo $page_con['status']==2?'active':'';?>"><a href="<?php echo spUrl($c,$a,array('status'=>2))?>">待制作</a></li>
                    ...
                    <span class="Btn Btn-blue float-right NewPop" data-url="/produce/editPlan" data-title="新增生产计划"><i class="icon-add"></i> 新增</span>
                                ...
                                <tr class="Results<?php echo $v['id'] ?>">
                                    ...
                                    <td>
                                        <div class="list-menu" style="display: inline-block;">
                                            操作  ＋
                                            <ul class="menu">
                                                <li class="menu-item NewPop" data-url="<?php echo spUrl($c, 'planInfo', array('id' => $v['id'])) ?>" data-title="生产计划详情"><a >详情</a></li>
                                                <li class="menu-item NewPop" data-url="<?php echo spUrl($c, 'editPlan', array('id' => $v['id'])) ?>" data-title="制作生产计划"><a >编辑</a></li>
