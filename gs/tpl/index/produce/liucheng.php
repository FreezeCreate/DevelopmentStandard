        ...
        <div class="Tables">
            <div class="TablesHead">
                <form action="" method="get">
                    ...
                    <span class="Btn Btn-blue float-right NewPop" data-url="<?php echo spUrl('produce', 'editDyctlog1',array('type'=>4));?>" data-title="新增生产过程检验流程卡"><i class="icon-add"></i> 新增</span>
                </form>
            </div>
            <?php if ($results) { ?>
                <div class="top20">
                                ...
                                <tr class="Results<?php echo $v['id'] ?>">
                                    ...
                                    <td>
                                        <div class="list-menu" style="display: inline-block;">
                                            操作  ＋
                                            <ul class="menu">
                                                <li class="menu-item NewPop" data-url="<?php echo spUrl($c, 'dyctlogInfo1', array('id' => $v['id'])) ?>" data-title="生产过程检验流程卡"><a >详情</a></li>
                                                <?php if($v['status']==0){?>
