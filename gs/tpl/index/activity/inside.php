        ...
        <div class="ContentBox">
            <div class="Tables">
                <div class="TablesHead">
                    ...
                    <div class="TablesAddBtn" onclick="fill_apply(33)">＋ 新增</div>
                </div>
                                ...
                                <?php foreach ($results as $k => $v) { ?>
                                    <tr>
                                        ...
                                        <td class="colorGre">
                                            ...
                                            操作  ＋
                                            <ul class="menu">
                                                <li class="menu-item"><a onclick="check_apply(33,<?php echo $v['id'] ?>)">详情</a></li>
                                                <li class="menu-item"><a onclick="fill_apply(33,<?php echo $v['id'] ?>)">编辑</a></li>
...
<script>
    function del(id) {
        Confirm('确定删除该活动？', function(e) {
            if (e) {
                $.post("<?php echo spUrl($c, "delInside"); ?>", {id:id}, function(data) {
                    if (data.status == 1) {
