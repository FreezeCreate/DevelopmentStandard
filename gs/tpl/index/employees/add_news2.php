            ...
            <div class="add-right" style="padding-top:10px; width:980px;">
                ...
                <table class="reg-table" style="width:900px; float:left;" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td class="td-2">
                            <input type="text" placeholder="请输入品牌名" class="txt" value="<?php echo $result['brand_name'];?>" id="brand" name="brand_name" /> &nbsp;&nbsp;<a href="Javascript:void(0)" onclick="brand_sub()" id="brandsdg">搜索</a>
                    ...
                    <tr>
                        ...
                        <td class="td-2">
                            <select class="sel" style="width:113px; float:left; margin-right:10px;" id="fcatid" name="category_id">
                                    ...
                                    <option value="<?php echo $value["id"]; ?>"  <?php echo ($results["category_id"]&& ($value["id"] == $results["category_id"]))?'selected="selected"':''; ?> ><?php echo $value["name"]; ?></option>
                                    <?php } ?>
                                </select>
                                    <?php if(1 ==2 ){?>   
                               <select class="sel" style="width:113px; float:left;margin-right:10px;" id="scatid" name="scatid">
                                    <option value="" selected="selected">请选择...</option>
...
<!--                     <tr  id="model2" >
               ...
               <?php } ?>  
                    ...
                    <tr>
                        <td class="td-1"><b>*</b>级别：</td>
                        <td class="td-2">
                            <input type="radio" name="level" <?php if($result["level"] == 1){ ?> checked <?php } ?> value="<?php echo 1; ?>" />1级&nbsp;&nbsp;
                            <input type="radio" name="level" <?php if($result["level"] == 2){ ?> checked <?php } ?> value="<?php echo 2; ?>" />2级&nbsp;&nbsp;  											   	 						<input type="radio" name="level" <?php if($result["level"] == 3){ ?> checked <?php } ?> value="<?php echo 3; ?>" />3级&nbsp;&nbsp; 						<input type="radio" name="level" <?php if($result["level"] == 0){ ?> checked <?php } ?> value="<?php echo 0; ?>" />不合格&nbsp;&nbsp; 
                        </td>
                        <td class="td-3"></td>
                    </tr>
                    <tr>
                        <td class="td-1"><b>*</b>审核：</td>
                        <td class="td-2">
                            <input type="radio" name="status" <?php if($result["status"] == 0 || $result["status"] == 3 ){ ?> checked <?php } ?> value="<?php echo 0; ?>" />未审核&nbsp;&nbsp;
                            <input type="radio" name="status" <?php if($result["status"] == 1){ ?> checked <?php } ?> value="<?php echo 1; ?>" />审核通过&nbsp;&nbsp;  
                            <input type="radio" name="status" <?php if($result["status"] == 2){ ?> checked <?php } ?> value="<?php echo 2; ?>" />未通过审核&nbsp;&nbsp; 
                        </td>
                    </tr>
                   <tr>
                        <td class="td-1">回复:</td>
                        <td class="td-2" style="width:500px;">
                            <div class="inp-w" style="color:red">
                                <textarea style="width: 300px; height: 100px;"><?php echo $result['reply'] ?></textarea>
                            </div>
                        </td>
                        <td class="td-3">&nbsp;</td>
                    </tr>
