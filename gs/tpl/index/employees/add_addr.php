        ...
        <div class="user-right">
                ...
                <table class="reg-table" style="width:900px; float:left;" cellpadding="0" cellspacing="0">
                    ...
                    <style>
                     ...
                     <tr>
                        ...
                        <td class="td-2">
                            <input type="radio" name="stauts" value="1" <?php if($result["stauts"] == 1 || empty($result['stauts'])){ ?> checked <?php } ?> />已合作&nbsp;&nbsp;
                     ...
                     <tr>
                        ...
                        <td class="td-2">
                           <textarea name="content" placeholder="描述不可低于50个字" style="min-height: 100px; min-width: 352px;"><?php echo $result["content"]; ?></textarea>
                        </td>
                        <td class="td-3">&nbsp;</td>
                    </tr>
            ...
            <form id="market_submit1" method="post">
                        ...
                        <tr>
                            <td class="td-1">&nbsp;</td>
                            <td class="td-2">
                                <a href="javascript:void(0);" id="submit_btn" class="btn-m btn-blue br3" switch="1" onclick="market_submit1();">保 存</a>
                                <a href="javascript:void(0);" class="btn-m btn-blue br3" onclick="$('.adds').css('display','none')">关 闭</a>
                            </td>
            ...
            <form id="market_submit2" method="post">
                        ...
                        <tr>
                            <td class="td-1">&nbsp;</td>
                            <td class="td-2">
                                <a href="javascript:void(0);" id="submit_btn" class="btn-m btn-blue br3" switch="1" onclick="market_submit2();">保 存</a>
                                <a href="javascript:void(0);" class="btn-m btn-blue br3" onclick="$('.adds').css('display','none')">关 闭</a>
                            </td>
            ...
            <form id="market_submit3" method="post">
                        ...
                        <tr>
                            <td class="td-1">&nbsp;</td>
                            <td class="td-2">
                                <a href="javascript:void(0);" id="submit_btn" class="btn-m btn-blue br3" switch="1" onclick="market_submit3();">保 存</a>
                                <a href="javascript:void(0);" class="btn-m btn-blue br3" onclick="$('.adds').css('display','none')">关 闭</a>
                            </td>
...
<script>
    ...
    function do_submit(){
        $.ajax({
            cache: false,
            type: "POST",
            url: "<?php echo spUrl("employees","save_shop_address"); ?>", //把表单数据发送到ajax.jsp
    ...
    function brand_submit(){
        ...
        //提交市场/商超添加
    function market_submit1(){
        $.ajax({
            cache: false,
            type: "POST",
            url: "<?php echo spUrl("employees","save_market"); ?>", //把表单数据发送到ajax.jsp
            data: $('#market_submit1').serialize(), //要发送的是ajaxFrm表单中的数据
            dataType: "json",
            async: false,
            error: function(request) {
                $.tip("数据请求失败！", 5);
            ...
            success: function(data) {  
            	if(data.status==1){
            	   $.tip('该市场/商超已经添加完成', 2);
                    $('#market1').val(data.msg);
                    $('#market_name1').val($('#m_name1').val());
    ...
    function market_submit2(){
        $.ajax({
            cache: false,
            type: "POST",
            url: "<?php echo spUrl("employees","save_market"); ?>", //把表单数据发送到ajax.jsp
            data: $('#market_submit2').serialize(), //要发送的是ajaxFrm表单中的数据
            dataType: "json",
            async: false,
            error: function(request) {
                $.tip("数据请求失败！", 5);
            ...
            success: function(data) {  
            	if(data.status==1){
            	   $.tip('该市场/商超已经添加完成', 2);
                    $('#market2').val(data.msg);
                    $('#market_name2').val($('#m_name2').val());
                    $('.adds').css('display','none');
            	}else{
            	   	$.tip(data.msg, 2);
            	}
    ...
    function market_submit3(){
        $.ajax({
            cache: false,
            type: "POST",
            url: "<?php echo spUrl("employees","save_market"); ?>", //把表单数据发送到ajax.jsp
            data: $('#market_submit3').serialize(), //要发送的是ajaxFrm表单中的数据
            dataType: "json",
            async: false,
            error: function(request) {
                $.tip("数据请求失败！", 5);
            ...
            success: function(data) {  
            	if(data.status==1){
            	   $.tip('该市场/商超已经添加完成', 2);
                    $('#market3').val(data.msg);
                    $('#market_name3').val($('#m_name3').val());
                    $('.adds').css('display','none');
            	}else{
            	   	$.tip(data.msg, 2);
            	}
