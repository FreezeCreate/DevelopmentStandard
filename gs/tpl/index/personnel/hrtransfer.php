        ...
        <div class="ContentBox">
            <div class="Tables">
                <div class="TablesHead">
                    ...
                    <div class="TablesAddBtn" onclick="fill_apply(14)">＋ 新增</div>
                </div>
                            ...
                            <tbody>
                                <?php foreach ($results as $k => $v) { ?>
                                    <tr class="Results<?php echo $v['id'] ?>">
                                        ...
                                        <td><?php echo $v['tranuname'] ?></td>
                                        <td><?php echo $v['type'] ?></td>
                                        <td><?php echo $v['udept'].'→'.$v['eudept'] ?></td>
                                        <td><?php echo $v['position'].'→'.$v['eposition'] ?></td>
                                        ...
                                        <td>
                                            ...
                                            操作  ＋
                                            <ul class="menu">
                                                <li class="menu-item"><a onclick="check_apply(14,<?php echo $v['id'] ?>)">详情</a></li>
                                                <?php if ($admin['id'] == $v['uid']) { ?>
                                                <li class="menu-item"><a onclick="fill_apply(14,<?php echo $v['id'] ?>)">编辑</a></li>
                                                <?php }?>
                                            </ul>
                                            </div>
                                        </td>
