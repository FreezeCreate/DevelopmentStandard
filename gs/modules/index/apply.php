...
class apply extends IndexController {
    ...
    function Pxjl() {
        ...
        $result = $this->result;
        $result['children'] = spClass('m_pxjl_ch')->findAll(array('pid' => $result['id']));
        $this->result = $result;
    }
    ...
    function Hzcp() {
        ...
        $result['children'] = spClass('m_hzcp_ch')->findAll(array('pid' => $result['id']));
...
//         $result['children'] = spClass('m_zztz_ch')->findAll('pid = ' . $result['id']);
        $result['children'] = spClass('m_zztz_ch')->findAll(array('pid' => $result['id']));
...
//         $result['children'] = spClass('m_sbwxjh_ch')->findAll('pid = ' . $result['id']);
        $result['children'] = spClass('m_sbwxjh_ch')->findAll(array('pid' => $result['id']));
...
//         $result['children'] = spClass('m_bsd_ch')->findAll('pid = ' . $result['id']);
        $result['children'] = spClass('m_bsd_ch')->findAll(array('pid' => $result['id']));
