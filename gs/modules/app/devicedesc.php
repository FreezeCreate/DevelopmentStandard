...
class devicedesc extends AppController
{
    ...
    function saveDeviceDesc()
    {
        ...
        $device_data            = spClass('m_device')->find(array('id' => $data['deviceid']));
        $data['deviceid']       = $device_data['id'];
        $data['devicename']     = $device_data['device_name'];
        $data['devicecateid']   = $device_data['device_cateid'];
        $data['devicecatename'] = $device_data['device_catename'];
