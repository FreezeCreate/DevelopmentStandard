    ...
    <body>
            ...
            <div class="box">
                ...
                <div class="loginRight">
                    ...
                    <div class="form">
                        <form id="retForm">
                            <div class="loginInp" >
                                <input type="text" class="name" name="username" placeholder="用户名/手机号"/>
                            </div>
                            <div class="loginInp" >
        ...
        <div class="chous">
            <div class="chousBox">
                ...
                <ul class="floatBox">
                    <li class="chousItem">
                        <a href="<?php echo spUrl('passport', 'protocol') ?>?key=1">
                            <div class="img1"></div>
                            <p>个人注册</p>
                        </a>
                    </li>
                    <li class="chousItem">
                        <a href="<?php echo spUrl('passport', 'protocol') ?>?key=2">
                            <div class="img2"></div>
                            <p>公司注册</p>
                        </a>
                    </li>
