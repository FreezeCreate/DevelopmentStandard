                        ...
                        <div class="FrameTable">
                            ...
                            <table class="FrameTableCont">
                                <tr>
                                    ...
                                    <td class="FrameGroupName"><span style='color:red'>*</span>公益对象</td>
                                    <td><input class='FrameGroupInput' type='text' name="objname" value='<?php echo $result['objname'] ?>'/></td>
                                </tr>
                                <tr>
...
$(function() {
    ...
    function do_sub() {
        ...
        $.ajax({
            cache: false,
            type: "POST",
            url: "<?php echo spUrl($c, "saveWActivity"); ?>",
