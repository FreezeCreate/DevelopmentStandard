                            ...
                            <table class="FrameTableCont">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        ...
                                        <a class="Btn" onclick="ChousPerson(Dep, 'two', '.dname', '.did', this)">选择</a>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td><span style="color:red;">*</span> 来源</td>
                                    <td><input class="FrameGroupInput" type="text" name="zuozhe" value="<?php echo empty($result['zuozhe'])?$admin['departmentname']:$result['zuozhe']; ?>"/></td>
                                    <td>时间</td>
...
<script>
    ...
    $(function() {
        $(document).on('click', '#Department .upBox-c .all-li li a', function() {
            $(this).toggleClass('active');
        });
        $('#getUser').click(function() {
            var ids = '';
            var names = '';
            for (var i = 0; i < $('#Department .upBox-c ul li a.active').length; i++) {
                ids += $('#Department .upBox-c ul li a.active').eq(i).attr('lang') + ',';
                names += $('#Department .upBox-c ul li a.active').eq(i).attr('title') + ',';
            }
            $('input[name="receid"]').val(ids.substring(0, ids.length - 1));
            $('input[name="recename"]').val(names.substring(0, names.length - 1));
            $('.close').click();
        });
        getDepartment();
    });
