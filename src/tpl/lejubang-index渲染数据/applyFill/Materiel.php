                    ...
                    <table class="table01">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>单位</td>
                                <td><input type="text" class="form-control" name="unit" value="<?php echo $result['unit'] ?>"/></td>
                            </tr>
                            <tr>
                                <td>库存</td>
                                <td><input type="text" class="form-control" name="stock" value="<?php echo $result['stock'] ?>"/></td>
                                <td></td>
                                <td></td>
                            </tr>
                            <tr>
