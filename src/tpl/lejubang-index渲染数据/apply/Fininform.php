...
<html>
    ...
    <body>
        <div class="Frame">
            <div class="FrameTit"><span class="FrameTitName">财务报销</span><span class="Close"></span></div>
            <div class="FrameBox">
                <div class="FrameCont">
                    <div class="FrameTable">
                        <div class="FrameTableTitl">财务报销</div>
                        <table class="FrameTableCont">
                            <tr>
                                <td class="FrameGroupName"> 单号：</td>
                            ...
                            <tr>
                                <td class="FrameGroupName"> 报销类别：</td>
                                <td><?php echo $result['type']?></td>
                                <td class="FrameGroupName">报销金额：</td>
