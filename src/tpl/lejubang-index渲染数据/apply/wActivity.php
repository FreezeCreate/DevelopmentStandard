                ...
                <div class="FrameCont">
                    <div class="FrameTable">
                        ...
                        <table class="FrameTableCont">
                            <tr>
                                <td class="FrameGroupName">公益主题：</td>
                                <td><?php echo $result['name'] ?></td>
                                <td class="FrameGroupName">公益对象：</td>
                                <td><?php echo $result['objname'];?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="FrameGroupName"> 公益地点</td>
                                <td colspan='3'><?php echo $result['address'] ?></td>   
                            </tr>
                            <tr>
                                <td class="FrameGroupName">公益所需</td>
